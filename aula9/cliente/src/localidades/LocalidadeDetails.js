...
function LocalidadeDetails(props) {
  ...
  const itemDetails = localidade.items.map(x => <ItemLocalidadeDetails item={x}/>)
    ...
    <Main>
        <section>
            ...
            <ItemDetail>
                ...
                <span>{localidade.localidade.descricao}</span>
            </ItemDetail>     
            <ItemDetail>
                <label>Estado</label>
                <span>{localidade.localidade.estado}</span>
            </ItemDetail>     
            <ItemDetail>
                <label>Valor Total</label>
                <span>R$ {localidade.valor}</span>
            </ItemDetail>
        </section>
        <DetailSection>
...
function ItemLocalidadeDetails(props) {
    const { item } =  props;
    if (item.tipo === 'hotel') {
        return (
            <ItemDetails>
